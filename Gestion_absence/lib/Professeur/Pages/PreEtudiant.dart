...
class PreEtudiant extends StatefulWidget {
  final String email;

  PreEtudiant(this.email);
  @override
  _PreEtudiantState createState() => _PreEtudiantState(email);
}

class _PreEtudiantState extends State<PreEtudiant> {
  String email;
  _PreEtudiantState(this.email);
